...
class BoardingAndDroppingPointScreen extends StatefulWidget {
  ...
  const BoardingAndDroppingPointScreen({Key? key}) : super(key: key);
                      ...
                      child: Tab(
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(
                                  () =>
                              SelectedBoardingPointNameForPage.value.isNotEmpty
                                  ? Flexible(
                                child: Wrap(
                                  children: [
                                    Text(
                      ...
                      child: Tab(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Obx(
                                  () =>
                              SelectedDroppingPointNameForPage.value.isNotEmpty
                                  ? Flexible(
                                child: Wrap(
                                  children: [
                                    Text(
  ...
  void pageRedirectWithoutDropupList()
  {
    if (tripType == "0") {
      Navigator.of(context)
          .pushNamed(PassengerInfoScreen.routeName);
    } else if (tripType == "1") {
      NavigatorConstants.TRIP_TYPE = "2";
      Navigator.of(context)
          .pushNamed(AvailableRoutesAppScreen.routeName);
    } else if (tripType == "2") {
