                        ...
                        if (snap.connectionState == ConnectionState.done) {
                          return myTicketModel != null
                              ...
                              PhysicalShape(
                                  clipBehavior: Clip.antiAliasWithSaveLayer,
                                  clipper:
                                      DolDurmaClipper(bottom: 0, holeRadius: 0),
                                  color: Colors.transparent,
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 5),
                                                    Text(
                                                        "${myTicketModel!.jMJourneyStartDate}",
                                                        style: TextStyle(
                                                            color:
                                                                Colors.white)),
                                                  ],
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      //
                                                      //   },
                                                      //   child: Text("${myTicketModel!.baseFare}",
                                                      //       style: TextStyle(
                                                      //           color: Colors.white,
                                                      //           fontSize: 17,
                                                      //           fontWeight:
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      onTap: () async {
                                                        // final url ="https://royalcruiser.com/";
      ...
      if (xmlElement) {
        ...
        for (var item in xmlElement1) {
          ...
          myTicketModel = MyTicketModel(
              ...
              amountInWords:
                  xmlElement.findElements("AmountInWords").first.text,
              ...
              cMCompanyLogo:
                  xmlElement.findElements("CM_CompanyLogo").first.text,
              ...
              custStateCode:
                  xmlElement.findElements("CustStateCode").first.text,
              ...
              invoiceNo: xmlElement.findElements("InvoiceNo").first.text,
              jMBookingDateTime:
          ...
          print("myTicketModel => ${myTicketModel!.pickupName}");
          print(
